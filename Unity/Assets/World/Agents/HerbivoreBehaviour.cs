...
{
    public abstract class HerbivoreBehaviour : IAgentBehaviour
    {
        ...
        public Func<IAgentBehaviour.States, IAgentBehaviour.States> Next() => current switch
        {
            ...
            IAgentBehaviour.States.FightAsPack => throw new NotImplementedException(), //herbivores don't hunt (in a group)
